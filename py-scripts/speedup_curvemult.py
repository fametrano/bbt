...
print(f"Fixed window 4   : {fixed_window_4 / benchmark:.0%}", cached_multiples.cache_info())
...
print(f"Fixed window 5   : {fixed_window_5 / benchmark:.0%}", cached_multiples.cache_info())
...
print(f"Fixed window 4 ca: {fixed_window_4_ca / benchmark:.0%}", cached_multiples.cache_info())
...
print(f"Sliding window 4 : {sliding_window_4 / benchmark:.0%}", cached_multiples.cache_info())
...
print(f"Sliding window 5 : {sliding_window_5 / benchmark:.0%}", cached_multiples.cache_info())
