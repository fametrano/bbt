...
datadir = path.join(path.dirname(__file__), "..", "..", "btclib", "btclib", "data")
...
h = 1
SEC2v1_params["secp160r2"] = [hex(p), hex(a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v2_params["secp521r1"] = [hex(p), hex(a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
Gx = 0x188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF1012
Gy = 0x07192B95FFC8DA78631011ED6B24CDD573F977A11E794811
NIST_params["nistp192"] = [hex(p), hex(p - 3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
Gx = 0xB70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21
Gy = 0xBD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34
NIST_params["nistp224"] = [hex(p), hex(p - 3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
Gx = 0x6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296
Gy = 0x4FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5
NIST_params["nistp256"] = [hex(p), hex(p - 3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
Gx = 0xAA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB7
Gy = 0x3617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F
NIST_params["nistp384"] = [hex(p), hex(p - 3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
NIST_params["nistp521"] = [hex(p), hex(p - 3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
h = 1
Brainpool_params["bpp160r1"] = [hex(p), hex(a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params["bpp192r1"] = [hex(p), hex(a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params["bpp224r1"] = [hex(p), hex(a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params["bpp256r1"] = [hex(p), hex(a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params["bpp320r1"] = [hex(p), hex(a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params["bpp384r1"] = [hex(p), hex(a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params["bpp512r1"] = [hex(p), hex(a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
