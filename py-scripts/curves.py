...
datadir = path.join(path.dirname(__file__),
                    "..", "..", "btclib", "btclib", "data")
...
h = 1
SEC2v1_params['secp112r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 4
SEC2v1_params['secp112r2'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v1_params['secp128r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 4
SEC2v1_params['secp128r2'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v1_params['secp160k1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v1_params['secp160r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v1_params['secp160r2'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v2_params['secp192k1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v2_params['secp192r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v2_params['secp224k1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v2_params['secp224r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v2_params['secp256k1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v2_params['secp256r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v2_params['secp384r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
SEC2v2_params['secp521r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
Gx = 0x188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012
Gy = 0x07192b95ffc8da78631011ed6b24cdd573f977a11e794811
NIST_params['nistp192'] = [hex(p), hex(
    p-3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
Gx = 0xb70e0cbd6bb4bf7f321390b94a03c1d356c21122343280d6115c1d21
Gy = 0xbd376388b5f723fb4c22dfe6cd4375a05a07476444d5819985007e34
NIST_params['nistp224'] = [hex(p), hex(
    p-3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
Gx = 0x6b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296
Gy = 0x4fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f5
NIST_params['nistp256'] = [hex(p), hex(
    p-3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
Gx = 0xaa87ca22be8b05378eb1c71ef320ad746e1d3b628ba79b9859f741e082542a385502f25dbf55296c3a545e3872760ab7
Gy = 0x3617de4a96262c6f5d9e98bf9292dc29f8f41dbd289a147ce9da3113b5f0b8c00a60b1ce1d7e819d7a431d7c90ea0e5f
NIST_params['nistp384'] = [hex(p), hex(
    p-3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
NIST_params['nistp521'] = [hex(p), hex(
    p-3), hex(b), [hex(Gx), hex(Gy)], hex(n), 1]
...
h = 1
Brainpool_params['bpp160r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params['bpp192r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params['bpp224r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params['bpp256r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params['bpp320r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params['bpp384r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
...
h = 1
Brainpool_params['bpp512r1'] = [hex(p), hex(
    a), hex(b), [hex(Gx), hex(Gy)], hex(n), h]
