...
[linux.md](https://github.com/dginst/bbt/blob/master/regtest-lab/linux.md), or
...
* generate a _legacy_ address (i.e. _p2pkh_, not _p2sh-segwit_ or _bech32_), optionally labelled with "used to sign", then use it to sign the message _"Hello, World"_ with the corresponding private key, finally verify the signature
